class MarketData(object):
    ...
    Args:
        rate (float):       the risk-free rate (percentage, annualized) 
        spot (float):       the underlying asset cash price (dollars)
        volatility (float): the underlying asset volatility (percentage, annualized)
        dividend (float):   the dividend yield (percentage, annualized)
